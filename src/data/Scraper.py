...
class Scraper:
    ...
    #         context = browser.new_context(user_agent="Mozilla/5.0 ... Chrome/123.0 ...")
    ...
    #                 links = [l.get('href') for l in links if l]
    #                 links = [l for l in links if '/all_comps/shooting' in l]

    #                 if len(links) > 0:
    #                     page.goto(f"http://fbref.com{links[0]}", wait_until="domcontentloaded")
    #                     html = page.content()
    ...
    #                 time.sleep(15)  # kleine Pause zwischen Teams, Anti-Bot
    ...
    #                 match_df = pd.concat([existing_df, match_df])
